  ...
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%">
      <template v-for="item in menuList" :key="item.roleName">
        <div v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#2A3542">
          ...
          <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#2A3542" text-color="#AEB2B7" active-text-color="#F8675E" default-active="0">
            ...
            <el-sub-menu :index="1+''" :style="menulistBorderBottom">
              <template #title>
            ...
            <el-sub-menu :style="menulistBorderBottom" v-for=" (menu,index) in item.backMenu" :key="menu.menu" :index="index+2+''">
              <template #title>
  ...
  methods: {
    ...
    setMenulistStyleHeightChange() {
      this.$nextTick(()=>{
        ...
        document.querySelectorAll('.menulist-item>.el-menu--horizontal>.el-sub-menu>.el-sub-menu__title').forEach(el=>{
          el.style.height = "60px"
          el.style.lineHeight = "60px"
        })
      })
