...
.search-input {
  ...
  color: var(--ink); padding: 8px 12px; outline: 0;
...
.chip {
  ...
  &.is-active { color: #fff; background: var(--ink); border-color: var(--ink); }
}
.view-toggle {
