    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="美食类别" prop="meishileibie">
          <el-input v-model="ruleForm.meishileibie" 
              placeholder="美食类别" clearable  :readonly="ro.meishileibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美食类别" prop="meishileibie">
              <el-input v-model="ruleForm.meishileibie" 
                placeholder="美食类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商铺所在地" prop="shangpusuozaidi">
          <el-input v-model="ruleForm.shangpusuozaidi" 
              placeholder="商铺所在地" clearable  :readonly="ro.shangpusuozaidi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商铺所在地" prop="shangpusuozaidi">
              <el-input v-model="ruleForm.shangpusuozaidi" 
                placeholder="商铺所在地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.meishizhaopian" label="美食照片" prop="meishizhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.meishizhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
